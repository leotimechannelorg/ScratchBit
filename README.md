...
- **Scratch comment character limits:** Scratch comments have a limit of 500 characters, which is less than many codes generated by ScratchBit. To share these codes, you can create a forum post on [this topic](https://scratch.mit.edu/discuss/topic/892346/?page=1#post-9273102) and link to it in a comment.
...
Instead of pasting the entire code into a comment, create a forum post with the code on [this topic](https://scratch.mit.edu/discuss/topic/892346/?page=1#post-9273102) and paste the link in the comment.
...
- Don't worry, we've got you covered! Instead of pasting the entire code into a comment, create a forum post with the code on [this topic](https://scratch.mit.edu/discuss/topic/892346/?page=1#post-9273102) and paste the link in the comment.
